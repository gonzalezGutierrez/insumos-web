...
<head>
    ...
    <style>
        ...
        .login-input:focus {
        outline: none;
        border-bottom: 2px solid #445c7c;
        }
    ...
    <div class="login-container">
        <section class="login" id="login">
            <header style="text-align: center;"><br>
                <img src="{{asset('logo.jpg')}}" style="width: 40%; height: 40%; margin: auto; border-radius: 50%;" alt="">
            </header>
            <form action="{{ route('login') }}"  class="login-form" action="#" method="post">
                @csrf
                @error('email')
                ...
                @enderror
                <input type="email" name="email" class="login-input" placeholder="Correo electronico" required autofocus/>
